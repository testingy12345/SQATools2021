...
from Data_Driven_Framework_dummy_ticket.base.selenium_code import selenium_driver, log
from Data_Driven_Framework_dummy_ticket.data.dummy_ticket_page_data1 import *
from dummy_ticket_website.data.dummy_ticket_page_data import dep_date_link, ret_date_link, delivery_option


class Dummy_Ticket(selenium_driver):
    def __init__(self , driver):
        log.info('Dummy Ticket booking class has started')
    ...
    def enter_order_notes(self,on):
        ...
        log.info('Dummy Ticket booking class has ended')